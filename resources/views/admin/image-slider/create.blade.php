          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Image Slider Form</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="{{route('image-slider.store') }}" enctype="multipart/form-data">
                <form>
                @csrf
                @if ($errors->any())
                  <div class="alert alert-danger">
               ...
               <div class="form-group">
                ...
                <br>
                <a href="{{ route('image-slider.index') }}" class="btn btn-warning">Cancel</a>
